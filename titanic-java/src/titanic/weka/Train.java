...
public class Train {
	...
	public static void main(String[] args) throws Exception {
		...
		String inputFile = System.getenv("InputFile");
		String outputPath = System.getenv("OutputPath");

		System.out.println(Instant.now() + ":Loading data from " + inputFile);

		ArffLoader trainLoader = new ArffLoader();
		trainLoader.setSource(new File(inputFile));
		 ...
		 */
		String writePath = outputPath + "titanic.model";
		SerializationHelper.write(writePath, classifier);
		System.out.println(Instant.now() + ":Saved trained model to titanic.model to :" + writePath);
