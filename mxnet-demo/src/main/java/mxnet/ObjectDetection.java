...
public class ObjectDetection {
    ...
    runObjectDetectionSingle(String modelPathPrefix, String inputImagePath, List<Context> context) {
        System.out.println("Analyzing image: %s".format(inputImagePath));
    ...
    public static void main(String[] args) {
        ...
        if ( dataPath == null )
            ...
            System.out.println("Loading images and model from: %s".format(dataPath));
            imagePath = dataPath + "/dog-ssd.jpg";
            modelPath = dataPath + "/resnet50_ssd_model";
        }
